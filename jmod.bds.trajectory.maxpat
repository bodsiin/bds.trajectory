...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 424.0, 491.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 245.0, 62.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 446.0, 112.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 165.0, 42.0, 82.0, 19.0 ],
					"text" : "mixpad y size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 423.0, 445.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 245.0, 42.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 312.0, 408.0, 112.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 165.0, 22.0, 81.0, 19.0 ],
					"text" : "mixpad x size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 420.0, 407.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 245.0, 22.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.0, 358.0, 112.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 62.0, 112.0, 19.0 ],
					"text" : "vert. acceleration"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 420.0, 357.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 62.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.0, 310.0, 106.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 42.0, 106.0, 19.0 ],
					"text" : "horiz. waving"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 415.0, 309.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 42.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 313.0, 275.0, 106.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 22.0, 106.0, 19.0 ],
					"text" : "traj. duration"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 414.0, 274.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 22.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 37.0, 541.0, 56.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 591.0, 103.0, 19.0 ],
					"text" : "jalg.bds.trajectory"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 13.0, 198.0, 578.0, 19.0 ],
					"text" : "jcom.hub @module_type control @description \"This module creates a trajectory for jmod.presetmixpad module\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 477.0, 237.0, 571.0, 19.0 ],
					"text" : "jcom.message start @type none @range/clipmode both @repetitions/allow 1 @description \"triggers trajectory\"",
					"varname" : "parameter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 481.0, 274.0, 568.0, 31.0 ],
					"text" : "jcom.parameter time @type decimal @range/bounds 0. 1000. @range/clipmode none @ramp/drive scheduler @dataspace none @dataspace/unit/native speed @priority 1 @description \"trajectory duration\"",
					"varname" : "time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 483.0, 308.0, 558.0, 31.0 ],
					"text" : "jcom.parameter freq @type decimal @range/bounds 0. 1000. @range/clipmode low @ramp/drive scheduler @dataspace none @dataspace/unit/native speed @priority 1 @description \"horizontal sinusoidal waving\"",
					"varname" : "freq"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 484.0, 350.0, 563.0, 31.0 ],
					"text" : "jcom.parameter accel @type decimal @range/bounds 0. 1000. @range/clipmode low @ramp/drive scheduler @dataspace none @dataspace/unit/native speed @priority 1 @description \"vertical sigmoid acceleration\"",
					"varname" : "accel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 484.0, 398.0, 567.0, 31.0 ],
					"text" : "jcom.parameter size/x @type decimal @range/bounds 0. 1920. @range/clipmode low @ramp/drive scheduler @dataspace none @dataspace/unit/native speed @priority 0 @description \"Mixpad x resolution\"",
					"varname" : "size/x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 483.0, 438.0, 567.0, 31.0 ],
					"text" : "jcom.parameter size/y @type decimal @range/bounds 0. 1080. @range/clipmode low @ramp/drive scheduler @dataspace none @dataspace/unit/native speed @priority 0 @description \"Mixpad y resolution\"",
					"varname" : "size/y"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 484.0, 483.0, 589.0, 43.0 ],
					"text" : "jcom.parameter rate @type decimal @range/bounds 0. 100. @range/clipmode low @ramp/drive scheduler @dataspace none @dataspace/unit/native speed @priority 1 @description \"time between two points in trajectory\" @repetitions/allow 0",
					"varname" : "rate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 37.0, 631.0, 546.0, 43.0 ],
					"text" : "jcom.return position/xy @type array @range/bounds 0. 1920. @range/clipmode low @dataspace position @dataspace/unit/native xy @description \"x and y coordinates of the trajectory as a list of two values\" @repetitions/allow 1",
					"varname" : "position/xy"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 46.5, 572.5, 442.5, 572.5 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 46.5, 572.5, 166.5, 572.5 ],
					"source" : [ "obj-24", 0 ]
				}
